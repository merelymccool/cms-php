        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="view-stats" class="col-lg-3 col-md-6">
                     ...
                     <div id="photo-stats" class="col-lg-3 col-md-6">
                     ...
                     <div class="col-lg-3 col-md-6">
                        <div id="user-stats" class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                      ...
                      <div class="col-lg-3 col-md-6">
                        <div id="comment-stats" class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
